...
namespace OOServerIsraelMaof
{
    ...
    public class WebCapture
    {
        ...
        private string user_agent = "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; bgft";
        ...
        public string DownloadHtmlWebFormPage(string url, NameValueCollection nvc)
        {
            ...
            {
                if (user_agent != null) web.Headers.Add("user-agent", user_agent);
            }
            else if (web.Headers["user-agent"] != null)
            {
                if (user_agent == null) web.Headers.Remove("user-agent");
            }
